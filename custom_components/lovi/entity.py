    ...
    def extra_state_attributes(self):
        ...
        for a in self._attr_dps:
            ...
            if value is not None or not a.optional:
                ...
                attr[a.name] = value
        health = self._device.health_status
        attr["lovi_health_ip"] = health.get("ip", "")
        attr["lovi_health_protocol"] = health.get("protocol_version", "")
        attr["lovi_health_failures"] = health.get("connection_failures", 0)
        return attr
